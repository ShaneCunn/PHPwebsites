...
if (isset($_GET)) {
   ...
   // $city = "galway";
    ...
    $user_temp = $jsonData['main']['temp'] -273.15;
        ...
        <div class="col-sm-8 text-left">
            ...
            <form>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="city" placeholder="City" value="<?php echo $_GET['city']; ?>">
                </div>
                <div class="form-group">
...
if (isset($weather_info['city'])) {
    $weather_info = $weather_info['city'];
}
if ($weather_info == null) {

    echo '<div class="alert alert-danger" role="alert">Sorry, Enter a city.</div>';
} else if ($weather_info) {

    echo '<div class="alert alert-success" role="alert">' . $weather_info . '</div>';
